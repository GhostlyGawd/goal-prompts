# Playbook: Zero to Shipped (conductor)

You are working inside this repo. Mission: execute the **Zero to Shipped** playbook — 11 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).
...
8. **141 · Scaffold the Rails** — fetch https://goal-prompts.vercel.app/raw/141.md → writes `SCAFFOLD.md`
9. **142 · Spec the Product** — fetch https://goal-prompts.vercel.app/raw/142.md → writes `SPEC.md`
10. **143 · Implement to Spec** — fetch https://goal-prompts.vercel.app/raw/143.md → writes `BUILDLOG.md`
11. **144 · Ship Gate** — fetch https://goal-prompts.vercel.app/raw/144.md → writes `SHIP-GATE.md`
