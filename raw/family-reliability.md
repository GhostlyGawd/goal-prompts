...
You are working inside this repo. Mission: execute the **All Reliability briefs** playbook — 4 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).
