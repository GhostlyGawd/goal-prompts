...
output: SHIP-GATE.md
related: 143 29 47
tagline: The adversarial go/no-go. Re-runs every check fresh, sabotages code to prove the tests bite, walks the revenue path end to end, and rules ship or hold.
---
# Goal: Ship Gate
