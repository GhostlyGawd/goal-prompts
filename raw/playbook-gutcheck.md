...
You are working inside this repo. Mission: execute the **Gut Check** playbook — 3 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
