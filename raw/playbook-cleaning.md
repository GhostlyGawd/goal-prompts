...
You are working inside this repo. Mission: execute the **Spring Cleaning** playbook — 4 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
