...
You are working inside this repo. Mission: execute the **Weekly Vitals** playbook — 1 audit brief in sequence, each producing one report file in the repo's `reports/` directory.
