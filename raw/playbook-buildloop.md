# Playbook: Build Loop (conductor)

You are working inside this repo. Mission: execute the **Build Loop** playbook — 4 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
