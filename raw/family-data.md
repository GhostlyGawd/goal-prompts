...
You are working inside this repo. Mission: execute the **All Data briefs** playbook — 9 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
