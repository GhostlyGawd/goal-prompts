# Playbook: Weekly Vitals (conductor)

You are working inside this repo. Mission: execute the **Weekly Vitals** playbook — 1 audit brief in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).

Ten minutes, trend arrows. Re-run every week.
