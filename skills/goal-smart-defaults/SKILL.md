---
name: goal-smart-defaults
description: "What the product decides so the user doesn't have to — prefilled forms, remembered choices, resume where you left off — and every question it had no right to ask. Goal Prompt 153 · Craft — inspects the current repo and writes DEFAULTS.md at the repo root."
---
