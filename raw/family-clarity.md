...
You are working inside this repo. Mission: execute the **All Clarity briefs** playbook — 7 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
