# Playbook: All Craft briefs (conductor)

You are working inside this repo. Mission: execute the **All Craft briefs** playbook — 5 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.

Every Craft brief in the catalog, in order — 152 through 156, one report each.
...
## Stages
1. **152 · Fit & Finish Audit** — fetch https://goal-prompts.vercel.app/raw/152.md → writes `POLISH.md`
2. **153 · Smart Defaults & Anticipation Audit** — fetch https://goal-prompts.vercel.app/raw/153.md → writes `DEFAULTS.md`
3. **154 · Perceived Speed Audit** — fetch https://goal-prompts.vercel.app/raw/154.md → writes `PERCEIVED-SPEED.md`
4. **155 · Compounding Value Audit** — fetch https://goal-prompts.vercel.app/raw/155.md → writes `COMPOUNDING.md`
5. **156 · Signature Moments Audit** — fetch https://goal-prompts.vercel.app/raw/156.md → writes `SIGNATURE.md`
