# Playbook: All Meta briefs (conductor)

You are working inside this repo. Mission: execute the **All Meta briefs** playbook — 2 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).
...
## Stages
1. **28 · Roadmap Synthesis** — fetch https://goal-prompts.vercel.app/raw/28.md → writes `ROADMAP.md`
