...
You are working inside this repo. Mission: execute the **All Design briefs** playbook — 9 audit briefs in sequence, each producing one report file at this repo's root.
...
4. **55 · Typography Audit** — fetch https://goal-prompts.vercel.app/raw/55.md → writes `TYPOGRAPHY.md`
5. **56 · Color & Contrast Audit** — fetch https://goal-prompts.vercel.app/raw/56.md → writes `COLOR.md`
6. **57 · Spacing & Layout Audit** — fetch https://goal-prompts.vercel.app/raw/57.md → writes `LAYOUT.md`
7. **58 · Interaction States & Motion Audit** — fetch https://goal-prompts.vercel.app/raw/58.md → writes `STATES.md`
8. **59 · Brand Coherence Audit** — fetch https://goal-prompts.vercel.app/raw/59.md → writes `BRAND.md`
9. **77 · Show, Don't Tell** — fetch https://goal-prompts.vercel.app/raw/77.md → writes `SHOWCASE.md`
