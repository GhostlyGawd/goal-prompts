# Playbook: All Mission briefs (conductor)

You are working inside this repo. Mission: execute the **All Mission briefs** playbook — 3 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).

Every Mission brief in the catalog, in order — 149 through 151, one report each.
...
3. **151 · The Debrief** — fetch https://goal-prompts.vercel.app/raw/151.md → writes `DEBRIEF.md`
