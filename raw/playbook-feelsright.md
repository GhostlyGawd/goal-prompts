# Playbook: Feels Right (conductor)

You are working inside this repo. Mission: execute the **Feels Right** playbook — 8 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.

The billion-dollar-feel pass: land the first win, teach the empty screens, then run the five Craft audits — fit and finish, smart defaults, perceived speed, compounding value, signature moments — and close the return trip.
...
## Stages
1. **80 · Activation & First-Win Audit** — fetch https://goal-prompts.vercel.app/raw/80.md → writes `ACTIVATION.md`
2. **133 · Empty & Zero-Data States Audit** — fetch https://goal-prompts.vercel.app/raw/133.md → writes `EMPTYSTATES.md`
3. **152 · Fit & Finish Audit** — fetch https://goal-prompts.vercel.app/raw/152.md → writes `POLISH.md`
4. **153 · Smart Defaults & Anticipation Audit** — fetch https://goal-prompts.vercel.app/raw/153.md → writes `DEFAULTS.md`
5. **154 · Perceived Speed Audit** — fetch https://goal-prompts.vercel.app/raw/154.md → writes `PERCEIVED-SPEED.md`
6. **155 · Compounding Value Audit** — fetch https://goal-prompts.vercel.app/raw/155.md → writes `COMPOUNDING.md`
7. **156 · Signature Moments Audit** — fetch https://goal-prompts.vercel.app/raw/156.md → writes `SIGNATURE.md`
8. **78 · Retention & Lifecycle Audit** — fetch https://goal-prompts.vercel.app/raw/78.md → writes `RETENTION.md`
