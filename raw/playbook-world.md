...
You are working inside this repo. Mission: execute the **Ship to the World** playbook — 3 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).
