...
You are working inside this repo. Mission: execute the **All AI-Ethics briefs** playbook — 5 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
