...
You are working inside this repo. Mission: execute the **All Growth briefs** playbook — 11 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
