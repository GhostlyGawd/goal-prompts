...
You are working inside this repo. Mission: execute the **Experience Optimization** playbook — 7 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
