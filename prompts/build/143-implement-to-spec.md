...
output: BUILDLOG.md
related: 142 144
tagline: The build loop. Takes the open acceptance criteria, asks the scope, then lands each one as a failing test, the least code to pass it, and a verified commit.
---
