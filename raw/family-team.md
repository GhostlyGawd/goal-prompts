...
You are working inside this repo. Mission: execute the **All Team briefs** playbook — 10 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
