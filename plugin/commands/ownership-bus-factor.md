---
description: "Read git history for the human risks — files only one person understands, critical paths with a truck factor of one, and the knowledge that leaves when they do."
---
