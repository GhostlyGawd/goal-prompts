...
You are working inside this repo. Mission: execute the **Ship a Public API** playbook — 6 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
