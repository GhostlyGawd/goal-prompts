---
id: "153"
title: Smart Defaults & Anticipation Audit
family: Craft
question: does it feel right?
output: DEFAULTS.md
tagline: What the product decides so the user doesn't have to — prefilled forms, remembered choices, resume where you left off — and every question it had no right to ask.
related: 80 133 152
---
