...
You are working inside this repo. Mission: execute the **All Product briefs** playbook — 5 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
