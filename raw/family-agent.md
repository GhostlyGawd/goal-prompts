...
You are working inside this repo. Mission: execute the **All Agent briefs** playbook — 12 audit briefs in sequence, each producing one report file in the repo's `reports/` directory.
