---
name: goal-signature-moments
description: "The moments users remember and retell — the first win, the share-worthy output, the one interaction worth a demo — placed with restraint, never confetti on command. Goal Prompt 156 · Craft — inspects the current repo and writes SIGNATURE.md at the repo root."
---
