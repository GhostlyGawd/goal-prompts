...
output: SCAFFOLD.md
related: 67 142
tagline: Instantiates the golden-path template into a fresh product repo and proves the gate bites — red fails, green passes — before any product code exists.
---
