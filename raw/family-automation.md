# Playbook: All Automation briefs (conductor)

You are working inside this repo. Mission: execute the **All Automation briefs** playbook — 3 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).
...
## Stages
1. **39 · Workflow Resilience Audit** — fetch https://goal-prompts.vercel.app/raw/39.md → writes `WORKFLOWS.md`
2. **40 · Determinism Boundary Audit** — fetch https://goal-prompts.vercel.app/raw/40.md → writes `BOUNDARIES.md`
3. **41 · Handoff Audit** — fetch https://goal-prompts.vercel.app/raw/41.md → writes `HANDOFFS.md`
