...
3. **Scale pressure** — hot paths, growing tables, latency complaints → Speed, "does it scale?" (04, 87, 88)
...
10. **Back-of-house gravity** — deploys, environments, incidents → Ops, "does it run?" (23, 73, 91); schema, migrations, analytics → Data, "is it sound?" (19, 21, 71)
