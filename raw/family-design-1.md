# Playbook: All Design briefs (1/2) (conductor)

You are working inside this repo. Mission: execute the **All Design briefs (1/2)** playbook — 9 audit briefs in sequence, each producing one report file at the repo root (or in `reports/`, if the repo has that directory).

Design briefs 54 through 105 — part 1 of 2, one report each.
